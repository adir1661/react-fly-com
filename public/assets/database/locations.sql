...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2019 at 10:33 AM
...
(1, 1, 'assets/img/antenna5.jpg'),
(2, 1, 'assets/img/antenna6.jpg'),
...
(3, '40.73920000', '-73.85300000', 'Forest Hills, Queens, NY 11375, USA', 0, 'Food Festival', '23 Hillhaven Drive', '323-843-4729', '', '', 'Event', 5, 'detail.html', 'assets/img/items/4.jpg', 'Starts at 19:00', 'Sed ac dolor auctor, elementum lacus vitae, efficitur magna. Quisque sed semper tellus', 'Last Tickets!', '', ''),
(4, '40.73970000', '-73.85000000', 'Forest Hills, Queens, NY 11375, USA', 0, 'Ironapple Same Location', '4209 Glenview Drive', '989-410-0777', 'hello@ironapple.com', 'http://www.ironapple.com', 'Bar & Grill', 3, 'detail.html', 'assets/img/items/2.jpg', 'Same Location', 'Aliquam vel turpis sagittis, semper tellus eget, aliquam turpis. Cras aliquam, arcu\"', '50%', '', '');
...
(1, 1, 'Jane Doe', 'assets/img/issue.jpg', '2016-06-07', 4, 'there was a issue with the antena collection information because of ...'),
(2, 1, 'Norma Brown', 'assets/img/issue.jpg', '2016-06-23', 5, 'lack of information about this issue, need more investigation please refer to system administrator'),
(3, 2, 'Catherine Doe', 'assets/img/issue.jpg', '2016-09-13', 5, 'Morbi varius orci in rhoncus posuere. Sed cursus urna ut sem rhoncus lacinia. Praesentac velit dignissim, mollis purus quis, sollicitudin eros'),
(4, 2, 'Peter Great', 'assets/img/issue.jpg', '2016-09-14', 3, 'Donec nec tristique sapien. Aliquam ante felis, sagittis sodales diam sollicitudin, dapibus semper turpis'),
(5, 1, 'Patrick Jamison', 'assets/img/issue.jpg', '2016-09-14', 5, 'Nam tincidunt mollis nibh at facilisis. Integer a orci a elit malesuada ultrices. Morbi facilisis, velit non fermentum laoreet, ligula dolor ullamcorper quam, a tristique risus est et ante.'),
(6, 3, 'Pete Jamison', 'assets/img/issue.jpg', '2016-09-14', 4, 'Nam tincidunt mollis nibh at facilisis. Integer a orci a elit malesuada ultrices. Morbi facilisis, velit non fermentum laoreet, ligula dolor ullamcorper quam, a tristique risus est et ante.'),
(7, 3, 'Suzanne Green', 'assets/img/issue.jpg', '2016-09-12', 5, 'Integer a orci a elit malesuada ultrices. Morbi facilisis, velit non fermentum laoreet, ligula dolor ullamcorper quam, a tristique risus est et ante.');
...
--
ALTER TABLE `gallery`
  MODIFY `image_id` int(128) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `opening_hours`
  MODIFY `openin_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
