...
'<div class="modal-item-detail modal-dialog" role="document" data-latitude="'. $latitude .'" data-longitude="'. $longitude .'" data-address="'. $address .'" data-id='.$_POST['id'].'>
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="right">
                <section>
                    <h3>Overview</h3>
                    <div class="read-more"><p>Markey\'s Hill, Antenna placed a Year ago , nonesence nonesence nonesence nonesence nonesence nonesence nonesence nonesence nonesence nonesence nonesence nonesence nonesence ...</p></div>
                </section>
                <!--end about-->';
